        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <h5
              ...
              class="stats-desc"
            >
              {{ profileData.segments[0].stats.timeSpentOnFire.displayValue }}
            </h5>
            <h5
              v-else-if="
                profileData.segments[0].stats.timeSpentOnFire.value &&
              ...
              class="stats-desc"
            >
              {{ profileData.segments[1].stats.timeSpentOnFire.displayValue }}
            </h5>
            <h5
              v-else-if="
                !profileData.segments[0].stats.timeSpentOnFire.value &&
          ...
          <div class="col-md-2">
            <h5
              ...
              class="stats-desc"
            >
              {{ profileData.segments[0].stats.mostObjectiveTime.displayValue }}
            </h5>
            <h5
              v-else-if="
                profileData.segments[0].stats.mostObjectiveTime.value &&
              ...
              class="stats-desc"
            >
              {{ profileData.segments[1].stats.mostObjectiveTime.displayValue }}
            </h5>
            <h5
              v-else-if="
                profileData.segments[0].stats.mostObjectiveTime.value &&
